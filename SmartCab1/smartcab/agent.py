...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #epsilon_n = self.epsilon - 0.05
            self.epsilon = self.epsilon - 0.005
            #alpha_n = self.alpha - 0.002
            # self.alpha = max(alpha_n, 0.2)
